...
function checkFormulario() { // Inicializa el juego
    ...
    let Filas = document.getElementById('Alto').value;
    let Columnas = document.getElementById('Ancho').value;
    let Bombas = document.getElementById('Minas').value;
